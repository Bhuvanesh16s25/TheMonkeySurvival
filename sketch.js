...
function preload(){
  ...
  song = loadSound("Captain Jack Sparrow theme music (1).mp3");
}
...
function draw(){
  ...
  if (gameState === PLAY){
    ...
    if (monkey.isTouching(obstacleGroup)){
      ...
      gameoverVid = createVideo("Game Over sound effect.mp4");
      gameoverVid.play();
      gameoverVid.size(600,300);
    }
  ...
  if (gameState === END){
    ...
    fill("black");
    textSize(15);
    text("Press 'ENTER' to Play Again", 240, 200);
    song.stop();
